...
liberalClusterDF.sort_values(by=["Clade","HeadOfClade"]).to_csv(f'liberalClusters-{build}.csv', header=True)
...
conservClusterDF.sort_values(by=["Clade","HeadOfClade"]).to_csv(f'conservativeClusters-{build}.csv', header=True)
